...
type TabType = 'dashboard' | 'orcamentos' | 'contas' | 'despesas' | 'ops' | 'previsao' | 'relatorios' | 'ponto'
        ...
        <form onSubmit={handleRegistrarPagamentoAvulso} className="space-y-4">
          {contaAvulsaParaPagar && (
            <div className="bg-blue-50 p-3 rounded-lg">
              <p className="text-sm text-gray-600">Descrição: <strong>{contaAvulsaParaPagar.descricao}</strong></p>
              <p className="text-sm text-gray-600">Valor total: <strong>{formatCurrency(contaAvulsaParaPagar.valor_total)}</strong></p>
              <p className="text-sm text-gray-600">Já recebido: <strong>{formatCurrency(contaAvulsaParaPagar.valor_pago)}</strong></p>
                ...
                <div key={index} className="bg-gray-50 p-4 rounded-lg space-y-3">
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    ...
                    <div>
                      ...
                      <div className="h-10 flex items-center px-3 bg-gray-100 rounded-lg text-gray-700 font-medium">
                        {formatCurrency(
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        >
          <div className="flex items-center">
            ...
            <div>
              <p className="text-gray-600 text-lg">Pagamentos Atrasados</p>
              <p
                className={`text-3xl font-bold ${
                  data.ops_atrasadas > 0 ? 'text-red-600' : 'text-gray-700'
                }`}
              >
                {data.ops_atrasadas}
              </p>
        ...
        >
          <div className="flex items-center">
            ...
            <div>
              <p className="text-gray-600 text-lg">Aguardando Pagamento</p>
        ...
        >
          <div className="flex items-center">
            ...
            <div>
              <p className="text-gray-600 text-lg">OPs sem Nota Fiscal</p>
...
function OrcamentosTab({
  ...
  return (
    <div className="space-y-4">
      ...
      {orcamentos.length === 0 ? (
        <Card>
          <p className="text-gray-600 text-center py-8 text-lg">Nenhum orçamento encontrado</p>
        </Card>
      ) : (
        <div className="space-y-3">
          {orcamentos.map((orc) => (
              ...
              <div className="flex items-center justify-between">
                <div className="flex-1 grid grid-cols-5 gap-4">
                  <div>
                    ...
                    <p className="text-gray-900 font-medium">{orc.cliente}</p>
                  </div>
                  <div>
                    <p className="text-sm font-semibold text-gray-600">Peça</p>
                    <p className="text-gray-900">{orc.nome_peca}</p>
                  </div>
                  <div>
                    <p className="text-sm font-semibold text-gray-600">Quantidade</p>
                    <p className="text-gray-900">{orc.quantidade}</p>
                  </div>
                  <div>
  ...
  return (
    <div className="space-y-4">
            ...
            <Card key={conta.id} className={`border-l-4 ${
              ...
              <div className="flex items-center justify-between">
                <div className="flex-1 grid grid-cols-5 gap-4">
                  <div>
                    <p className="text-sm font-semibold text-gray-600">Cliente</p>
                    <p className="text-gray-900 font-bold">{conta.cliente}</p>
                    {conta.cnpj_cliente && <p className="text-xs text-gray-500">{conta.cnpj_cliente}</p>}
                  </div>
                  <div className="col-span-2">
                    <p className="text-sm font-semibold text-gray-600">Descrição</p>
                    <p className="text-gray-900">{conta.descricao}</p>
                    {conta.numero_documento && <p className="text-xs text-gray-500">Doc: {conta.numero_documento}</p>}
                  </div>
                  <div>
                    <p className="text-sm font-semibold text-gray-600">Valor</p>
                    <p className="font-bold text-gray-900">{formatCurrency(conta.valor_total)}</p>
                  ...
                  <div>
                    ...
                    <p className="text-gray-900">{formatDate(conta.data_vencimento)}</p>
      ...
      <Modal isOpen={showExcluirAvulsaModal} onClose={() => setShowExcluirAvulsaModal(false)} title="Excluir Conta">
        <p className="text-gray-600 mb-6">Tem certeza que deseja excluir a conta de <strong>{avulsaParaExcluir?.cliente}</strong>?</p>
        <div className="flex gap-3">
      ...
      {contas.length === 0 && contasAvulsas.length === 0 ? (
        <Card>
          <p className="text-gray-600 text-center py-8 text-lg">Nenhuma conta encontrada. Clique em "Nova Conta" para criar uma conta avulsa.</p>
        </Card>
        ...
        <div className="space-y-3">
          {contas.map((conta) => (
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex-1 grid grid-cols-6 gap-4">
                  <div>
                    ...
                    <p className="text-gray-900 font-bold">{conta.codigo}</p>
                  </div>
                  <div>
                    <p className="text-sm font-semibold text-gray-600">Cliente</p>
                    <p className="text-gray-900">{conta.cliente}</p>
                  </div>
                  <div>
                    <p className="text-sm font-semibold text-gray-600">Valor Total</p>
                    <p className="text-gray-900 font-bold">{formatCurrency(conta.valor_total)}</p>
                  </div>
                  <div>
                  ...
                  <div>
                    <p className="text-sm font-semibold text-gray-600 mb-1">Situação</p>
                    <span
              ...
              <div className="text-xs text-gray-500 mt-3 pt-3 border-t flex gap-4">
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex-1 grid grid-cols-5 gap-4">
                  <div>
                    <p className="text-sm font-semibold text-gray-600">OP</p>
                    <p className="text-gray-900 font-bold">{prev.codigo}</p>
                  </div>
                  <div>
                    <p className="text-sm font-semibold text-gray-600">Cliente</p>
                    <p className="text-gray-900">{prev.cliente}</p>
                  </div>
                  <div>
                    <p className="text-sm font-semibold text-gray-600">Peça</p>
                    <p className="text-gray-900">{prev.nome_peca}</p>
                  </div>
                  <div>
                    <p className="text-sm font-semibold text-gray-600">Valor</p>
                    <p className="text-gray-900 font-bold text-lg">
    ...
    <div className="space-y-6">
      ...
      {contasFiltradas.length === 0 ? (
        <div className="text-center py-12">
          ...
          <p className="mt-4 text-gray-500">Nenhuma conta encontrada</p>
        </div>
      ) : (
                ...
                <tr key={conta.id} className="border-b hover:bg-gray-50">
                  <td className="p-4">
                    <div>
                      ...
                      {conta.fornecedor && (
                        <p className="text-sm text-gray-500">{conta.fornecedor}</p>
                      )}
                    </div>
                  </td>
                  <td className="p-4">
        ...
        {selectedConta && (
          <form onSubmit={handlePagar} className="space-y-4">
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <p className="text-sm text-gray-600">Valor Total: {formatCurrency(selectedConta.valor)}</p>
              <p className="text-sm text-gray-600">Já Pago: {formatCurrency(selectedConta.valor_pago || 0)}</p>
          ...
          {reportTypes.map((report) => (
            <Card key={report.id} className="cursor-pointer hover:shadow-lg hover:border-blue-500 transition-all" onClick={() => setSelectedReport(report.id as ReportType)}>
              <div className="flex items-start gap-4">
                ...
                <div><h3 className="font-bold text-lg text-gray-900">{report.label}</h3><p className="text-gray-600 text-sm mt-1">{report.description}</p></div>
              </div>
            </Card>
          ))}
        </div>
            ...
            <div>
              <Card className="no-print">
                ...
                <div className="flex gap-4 items-end">
                  <div className="flex-1">
                    <label className="block text-sm font-semibold text-gray-700 mb-2">Ordem de Produção</label>
          ...
          {selectedReport === 'producao' && (
            <div>
              <Card className="no-print">
                ...
                <div className="flex gap-4 items-end">
                  <div><label className="block text-sm font-semibold text-gray-700 mb-2">Início</label><input type="date" value={periodoInicio} onChange={(e) => setPeriodoInicio(e.target.value)} className="px-4 py-3 border-2 border-gray-300 rounded-lg text-lg" /></div>
                  <div><label className="block text-sm font-semibold text-gray-700 mb-2">Fim</label><input type="date" value={periodoFim} onChange={(e) => setPeriodoFim(e.target.value)} className="px-4 py-3 border-2 border-gray-300 rounded-lg text-lg" /></div>
...
function PrintHeader({ title, subtitle }: { title: string; subtitle?: string }) {
  return (
    <div className="text-center border-b-2 border-gray-800 pb-4 mb-6">
      ...
      <p className="text-sm text-gray-500 mt-2">Emitido: {new Date().toLocaleDateString('pt-BR')} {new Date().toLocaleTimeString('pt-BR')}</p>
    </div>
  )
}

function PrintFooter() {
  return <div className="mt-8 pt-4 border-t text-center text-sm text-gray-500">RJ Usinagem - Sistema de Gestão</div>
}
    ...
    <Card>
      ...
      <div className="border-2 border-gray-800 p-4 mb-4">
        <div className="flex justify-between items-center border-b pb-3 mb-4">
          <div><span className="text-sm text-gray-600">CÓDIGO</span><p className="text-3xl font-bold">{op.codigo}</p></div>
          <div className="text-right"><span className="text-sm text-gray-600">TIPO</span><p className="text-xl font-semibold uppercase">{op.tipo}</p></div>
          <div className="text-right"><span className="text-sm text-gray-600">STATUS</span><p className="text-xl font-semibold uppercase">{op.status.replace('_', ' ')}</p></div>
        </div>
        <div className="grid grid-cols-2 gap-6">
          <div className="space-y-3">
            <div><span className="text-xs text-gray-600">CLIENTE</span><p className="text-lg font-semibold">{op.cliente}</p></div>
            <div><span className="text-xs text-gray-600">PEÇA</span><p className="text-lg font-semibold">{op.nome_peca}</p></div>
            <div><span className="text-xs text-gray-600">QUANTIDADE</span><p className="text-lg font-semibold">{op.quantidade_total} peças</p></div>
            <div><span className="text-xs text-gray-600">VALOR</span><p className="text-lg font-semibold">{formatCurrency(op.preco_servico)}</p></div>
          </div>
          <div className="space-y-3">
            <div><span className="text-xs text-gray-600">INÍCIO</span><p className="text-lg font-semibold">{formatDate(op.data_inicio)}</p></div>
            <div><span className="text-xs text-gray-600">TÉRMINO</span><p className="text-lg font-semibold">{formatDate(op.data_termino)}</p></div>
            <div><span className="text-xs text-gray-600">MÁQUINA</span><p className="text-lg font-semibold">{op.maquina_utilizada || '-'}</p></div>
            <div><span className="text-xs text-gray-600">OPERADOR</span><p className="text-lg font-semibold">{op.operador_responsavel || '-'}</p></div>
          </div>
        </div>
      </div>
      <div className="border-2 border-gray-800 p-4 mb-4">
      ...
      <div className="border-2 border-gray-800 p-4 mb-4">
        ...
        <div className="grid grid-cols-3 gap-4 text-sm">
          <div><span className="text-gray-600">Material:</span> {op.material || '-'}</div>
          <div><span className="text-gray-600">Código:</span> {op.codigo_descricao_material || '-'}</div>
          <div><span className="text-gray-600">Qtd:</span> {op.quantidade_material || '-'}</div>
          <div><span className="text-gray-600">Lote:</span> {op.lote || '-'}</div>
          <div><span className="text-gray-600">Fornecedor:</span> {op.fornecedor || '-'}</div>
        </div>
      </div>
  ...
  return (
    <Card>
      ...
      <div className="grid grid-cols-3 gap-4 mb-6">
        <div className="border-2 border-gray-800 p-4 text-center"><p className="text-sm text-gray-600">FATURADO</p><p className="text-2xl font-bold text-green-700">{formatCurrency(dashboardData?.faturado_mes || 0)}</p></div>
        <div className="border-2 border-gray-800 p-4 text-center"><p className="text-sm text-gray-600">RECEBIDO</p><p className="text-2xl font-bold text-blue-700">{formatCurrency(dashboardData?.recebido_mes || 0)}</p></div>
        <div className="border-2 border-gray-800 p-4 text-center"><p className="text-sm text-gray-600">EM ABERTO</p><p className="text-2xl font-bold text-orange-700">{formatCurrency(dashboardData?.total_em_aberto || 0)}</p></div>
      </div>
      <div className="grid grid-cols-3 gap-4 mb-6">
